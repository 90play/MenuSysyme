...
void UMainMenu::SetServerList(TArray<FServerData> ServerNames)
{
	...
	for (const FServerData& ServerData : ServerNames)
	{
		...
		FString FractrionText = FString::Printf(TEXT("%d/%d"), ServerData.CurrentPlayers, ServerData.MaxPlayers);
		Row->ConnectionFraction->SetText(FText::FromString(FractrionText));
		Row->Setup(this, i);
		++i;
